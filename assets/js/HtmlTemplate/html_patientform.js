function get_forms(section_id, type = 0,tab_id) {
...
function getFormInputValues1(section_id,queryPara)
{
    let formData = new FormData();
    formData.set("section_id", section_id);
